...
<div class="login100-form-avatar">
	<a href="Student.php"><img src="images/kare_logo.png" alt="AVATAR"></a>
</div>
...
<div class="wrap-input100 validate-input m-b-10">
<input type="text" name="CourseID" class="input100" placeholder="Course ID">
<span class="focus-input100"></span>
	<span class="symbol-input100">
...
<a href="Student.php" class="txt1">Back to login</a>
</div>
</form>
</div>
</div>
...
<div class="text-center w-full p-t-25 p-b-230">
<a href="Student.php?create_user" class="txt1">Create an account</a>
</div>
