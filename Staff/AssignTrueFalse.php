...
<html lang="en">
<head>
    <title>Create Assignment True/False</title>
    <meta charset="utf-8">
...
// function SubmitData()
// {
include "AssignTrueFalseDetails.php";
include "AssignQuizDetails.php";
if(isset($_POST['Submit'])) 
{ 
    $buttonClick = new TrueFalseDetails;
    $buttonClick->StaffTrueFalsePostData();
}
...
<div class="jumbotron" style="background-color: #222d32; padding-top: 5px; padding-bottom: 15px;">
    <h1 style="background-color: white; color: #222d32;">CREATE ASSIGMENT TRUE/FALSE</h1>
</div>
