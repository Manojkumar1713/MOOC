...
<div class="login100-form-avatar">
	<a href="Staff.php"><img src="images/kare_logo.png" alt="AVATAR"></a>
</div>
...
<input type="text" name="StaffID" class="input100" placeholder="Staff ID">
...
<a href="Staff.php" class="txt1">Back to login</a>
</div>
</form>
</div>
</div>
...
<div class="text-center w-full p-t-25 p-b-230">
<a href="Staff.php?create_user" class="txt1">Create an account</a>
</div>
