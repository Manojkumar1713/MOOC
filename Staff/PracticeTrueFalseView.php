...
include "TrueFalseDetails.php";
    ...
    $arr=$buttonClick-> PracticeStaffTrueFlaseSpecific();
?>

<div class="container-fluid">
<div class="jumbotron" style="background-color: #222d32; padding-top: 25px; padding-bottom: 25px;">
    <h1 style="background-color: white; color: #222d32;">VIEW PRACTICE TRUE/FALSE</h1>
</div>
...
foreach($arr as $a){
    ...
    <?php
     ...
     $_SESSION['SID']=$b;
     echo( $_SESSION['SID']);
     $ar=$buttonClick->PracticeDeleteTrueFalse();
     //header("Location: ./CourseSpecificRedirect.php");
     echo("<script>location.href = './PracticeTrueFalseView.php';</script>");
     }
     ?>
