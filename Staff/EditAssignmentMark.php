...
<html lang="en">
<head>
    <title>Assign Assignment Mark</title>
    <meta charset="utf-8">
...
<div class="jumbotron" style="background-color: #222d32; padding-top: 5px; padding-bottom: 15px;">
    <h1 style="background-color: white; color: #222d32;">EDIT ASSIGNMENT MARK</h1>
</div>
...
if(isset($_POST['Submit'])){
    ...
    $studentmark->assignMarkFileType();
    echo("<script>location.href = './EditAssignmentMark.php';</script>");
}
 }?>
</table>
</div>
