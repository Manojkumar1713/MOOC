...
class QuizDetails{
    ...
    public function DeleteQuiz()
        ...
        public function PracticePostData(){
            ...
            $sql=$conn->prepare("INSERT INTO practicequiz ( Unit,Topic,FilePath, Qname, opA, opB, opC, opD, correct,correct2,correct3,QuestionType,CourseID,StaffID)
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            public function PracticeGetStaffSpecificQuiz(){
                //session_start();
                $GetSpecificQuizDetails=array();
               ...
               $vari="$vari";
               //echo($vari);
                $sql = "SELECT * FROM practicequiz INNER JOIN topic on practicequiz.Topic=topic.topic WHERE practicequiz.CourseID = '{$vari}'";
                //echo($sql);
                $result = mysqli_query($conn, $sql);
                //var_dump($result);
                if (mysqli_num_rows($result) > 0) 
            ...
            public function PracticeDeleteQuiz()
            {
                session_start();
                $GetStudents=array();
               ...
               $vari="$vari";
               //echo($vari);
                $sql = "DELETE FROM practicequiz WHERE Qid = '{$vari}'";
                //echo($sql);
                $result = mysqli_query($conn, $sql);
                //var_dump($result);
                if (mysqli_num_rows($result) > 0) 
