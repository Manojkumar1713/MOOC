...
class CourseDetails{
    ...
    public function GetStudentDetails(){
       ...
       $vari="$vari";
       //echo($vari);
        $sql = "SELECT student.RegNo,student.Name,student.CLG,student.Dept,student.Email,student.PhoneNo FROM student  INNER JOIN registeredcourse on student.RegNo=registeredcourse.RegNo WHERE student.CLG='KARE' ORDER BY student.RegNo";
        //echo($sql);
        $result = mysqli_query($conn, $sql);
        //var_dump($result);
        if (mysqli_num_rows($result) > 0) 
    ...
    public function GetOtherStudentDetails(){
        session_start();
        $GetStudents=array();
       ...
       $vari="$vari";
       //echo($vari);
        $sql = "SELECT student.RegNo,student.Name,student.CLG,student.Dept,student.Email,student.PhoneNo FROM student  INNER JOIN registeredcourse on student.RegNo=registeredcourse.RegNo WHERE NOT student.CLG='KARE' ORDER BY student.RegNo";
        //echo($sql);
        $result = mysqli_query($conn, $sql);
        //var_dump($result);
        if (mysqli_num_rows($result) > 0) 
...
//var_dump($newarr);
    ...
    public function PracticeInsertTrueFalse()
        ...
        $sql = "UPDATE administrator SET Password={$vari} WHERE ID={$vari2} ";
