...
<html lang="en">
<head>
    <title>Assignment True/False</title>
    <meta charset="utf-8">
...
foreach($trueFalse as $m){
    ...
    if($count==0){
        echo("<script>location.href = './NewTestAssignShortAns.php';</script>");
    }
//var_dump($trueFalse);
?>
<div class="form-group">    
<label><h1><?php echo("Topic:".$trueFalse[0]['topic']); ?></h1></label>
<br>
<label><h1><?php echo("Expiry Time:".date('m/d/Y H:i:s',$trueFalse[0]['ExpiryTime'])); ?></h1></label>
</div>
...
<input type="radio" name="<?php echo($m['id']);?>" value="<?php echo($m['opB']);?>" >
    ...
    if(isset($_POST['Submit'])){
        $instance->AssignInsertTrueFalse();
        echo("<script>location.href = './NewTestAssignShortAns.php';</script>");
    }
    }
}
