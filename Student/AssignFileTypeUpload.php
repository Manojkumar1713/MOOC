...
$filetype=$instance->AssignretriveFiletype();
$count=0;
$counter=0;
foreach($filetype  as $m){
...
<label><h1><?php echo("Topic:".$filetype[0]['topic']); ?></h1></label>
<br>
<label><h1><?php echo("Expiry Time:".date('m/d/Y H:i:s',$filetype[0]['ExpiryTime'])); ?></h1></label>
</div>
