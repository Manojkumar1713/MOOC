...
global $arr;
$topicname=$newarray[0]['Topic'];
$topicExpiry=$newarray[0]['ExpiryTime'];
 $score=0;
 $options;
 $counter=0;
 $count=0;
foreach($newarray as $m){
    ...
    if($count==0){
        echo("<script>location.href = './NewTestTrueFalse.php';</script>");
    }
// $unitNo=
//  echo($MCQ)
//$newarr=array();
